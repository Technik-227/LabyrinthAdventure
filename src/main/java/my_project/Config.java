...
public class Config {
    ...
    public final static String WINDOW_TITLE = "Labyrinth Adventure- Game 2";
    ...
    public final static int WINDOW_WIDTH = 1935;
    public final static int WINDOW_HEIGHT = 1050 + 29;   // Effektive Höhe ist etwa 29 Pixel geringer (Titelleiste wird mitgezählt)
